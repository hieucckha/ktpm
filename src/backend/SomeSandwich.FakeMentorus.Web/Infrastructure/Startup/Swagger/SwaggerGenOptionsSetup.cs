...
namespace SomeSandwich.FakeMentorus.Web.Infrastructure.Startup.Swagger;
...
internal class SwaggerGenOptionsSetup
{
    ...
    public void Setup(SwaggerGenOptions options)
    {
        ...
        options.IncludeXmlCommentsWithRemarks(GetAssemblyLocationByType(typeof(SomeSandwich.FakeMentorus.UseCases.Common.Pagination.PageQueryFilter)));
        options.IncludeXmlCommentsWithRemarks(GetAssemblyLocationByType(typeof(SomeSandwich.FakeMentorus.UseCases.Users.AuthenticateUser.TokenModel)));
